...
def moch_yayan():
    ...
    print ' [%s01%s]. Dump id dari teman publik'%(O,N);time.sleep(0.03)
    print ' [%s01%s]. Dump id dari total followers'%(O,N);time.sleep(0.03)
    print ' [%s01%s]. Dump id dari like postingan'%(O,N);time.sleep(0.03)
    print ' [%s01%s]. Mulai crack'%(O,N);time.sleep(0.03)
    print ' [%s01%s]. Check ingformasi akun fb'%(O,N);time.sleep(0.03)
    print ' [%s01%s]. Lihat hasil crack'%(O,N);time.sleep(0.03)
    print ' [%s01%s]. Settings user agent'%(O,N);time.sleep(0.03)
    print ' [%s01%s]. Ingfo %sscript%s'%(O,N,O,N);time.sleep(0.03)
    print ' [%s01%s]. logout (%shapus token%s)'%(M,N,M,N);time.sleep(0.03)
    pepek = raw_input('\n [*] menu : ')
    if pepek == '':
