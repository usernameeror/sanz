...
def ingfo(user, pw, status):
	try:
		...
		if status == "Berhasil":
			print ("\r%s [OK] Akun Live🥳                   "%(H))
			print ("\r%s [OK] Nama akun %s> %s%s          "%(H,M,H,str(nama)))
			print ("\r%s [OK] Pengikut  %s> %s%s          "%(H,M,H,str(pengikut)))
			print ("\r%s [OK] Mengikuti %s> %s%s          "%(H,M,H,str(mengikuti)))
			print ("\r%s [OK] Username  %s> %s%s          "%(H,M,H,user))
			print ("\r%s [OK] Password  %s> %s%s          \n"%(H,M,H,pw))
