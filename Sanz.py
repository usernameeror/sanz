...
def moch_yayan():
    ...
    print '\033[0;96m___________________________________________________________\n';time.sleep(0.03)
    print ' \x1b[1;92m[%s1%s]%s. Dump id dari teman'%(O,N);time.sleep(0.03)
    print ' \x1b[1;92m[%s2%s]%s. Dump id dari teman publik'%(O,N);time.sleep(0.03)
    print ' \x1b[1;92m[%s3%s]%s. Dump id dari total followers'%(O,N);time.sleep(0.03)
    print ' \x1b[1;92m[%s4%s]%s. Dump id dari like postingan'%(O,N);time.sleep(0.03)
    print ' \x1b[1;92m[%s5%s]%s. Mulai crack'%(O,N);time.sleep(0.03)
    print ' \x1b[1;92m[%s6%s]%s. Check ingformasi akun fb'%(O,N);time.sleep(0.03)
    print ' \x1b[1;92m[%s7%s]%s. Lihat hasil crack'%(O,N);time.sleep(0.03)
    print ' \x1b[1;92m[%s8%s]%s. Settings user agent'%(O,N);time.sleep(0.03)
    print ' \x1b[1;92m[%s9%s]%s. Ingfo %sscript%s'%(O,N,O,N);time.sleep(0.03)
    print ' \x1b[1;92m[%s0%s]%s. logout (%shapus token%s)'%(M,N,M,N);time.sleep(0.03)
    pepek = raw_input('\n [*] menu : ')
    if pepek == '':
